      ...
      <Card className="w-full max-w-md shadow-xl">
        ...
        <CardContent>
          <form onSubmit={submit} className="space-y-4">
            ...
            <Button className="w-full" disabled={loading || !token}>{loading ? 'Updating...' : 'Update password'}</Button>
            {!token && <div className="text-xs text-red-600 text-center">Missing token. Please use the link from your email.</div>}
          </form>
        </CardContent>
      </Card>
    </div>
